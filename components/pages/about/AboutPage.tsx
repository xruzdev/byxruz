          ...
          {[
            {
              ...
              description:
                "Sistemas personalizados para automatizar tareas y procesos, mejorando la eficiencia y productividad de tu negocio. Creacion de chatbots, integraciones con APIs, automatización de flujos de trabajo y más.",
            },
            {
              title: "Desarrollo",
              description:
            ...
            <div
              key={index}
              className="w-full md:w-1/3 xl:w-1/4 h-auto border-t pt-10 md:pt-15 border-main  relative z-501"
            >
              <span className="absolute text-main -top-10 left-0 hidden md:block text-sm">
                0{index + 1}
              </span>
        ...
        <div className="wrapper w-full grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:px-10 gap-10 md:mt-5 md:pt-5 justify-items-center xl:gap-y-20">
          {[
            ...
            <div key={index} className="w-full xl:w-3/4 h-auto z-501 ">
              <h3 className="text-2xl md:text-3xl xl:text-4xl font-semibold mb-2 xl:mb-6 pb-2 text-start  border-b border-main ">
                {item.type}
              </h3>
