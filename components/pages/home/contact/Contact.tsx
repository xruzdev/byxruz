      ...
      >
          ...
          <div className="panel sticky top-0 left-0 w-screen h-screen flex flex-nowrap items-start justify-start">
            <div className="absolute top-0 left-0 w-[200%] h-screen flex items-center justify-center overflow-hidden ">
              <h3 className="  text-8xl xl:text-9xl 2xl:text-[12rem] font-bold text-center uppercase ">
                Dale, empecemos algo juntos <span className="text-main">.</span>
              </h3>
            </div>
          </div>
        </div>
        ...
        <div className="link-container  hidden lg:block  ">
          <Link
            ...
            href="/contact"
            className="  mx-auto hidden lg:flex translate-y-60 active:scale-95 2xl:translate-y-50 lg:size-27 relative xl:size-32 2xl:size-44 border border-main rounded-full  items-center justify-center"
          >
            <img
              src="/contact-link-dark.png"
              alt="contact"
              className="rotate size-[84%]  absolute  "
            />
            <div className="size-[50%] border rounded-full  border-main flex items-center justify-center">
              <img
                src="/xruz-logo-2.png"
                alt="logo"
        ...
        <h3 className="mobile-h3 font-text!  opacity-10 mt-30 text-5xl md:text-7xl font-bold text-center uppercase lg:hidden px-3">
          Empecemos a trabajar juntos <span className="text-main">.</span>
        </h3>
        ...
        <div className="opacity-0 translate-y-50 2xl:translate-y-50 mobile-link-container w-full z-500 flex items-center justify-center">
          <Link
            href="/contact"
            className="mobile-link bg-main   mb-30 mt-10 uppercase text-background z-500 lg:hidden relative xl:mt-10 text-base  px-14 py-4  rounded-[45px] active:scale-95 transition-all duration-500 ease-linear hover:scale-105  hover:text-background"
          >
            Contactame
          </Link>
        </div>
